export enum ServiceIdentifiers {
    ...
    IHtmlObfuscator = 'IHtmlObfuscator',
    ...
    IObfuscationWarningsStorage = 'IObfuscationWarningsStorage',
    IOptions = 'IOptions',
    ...
    IVMBytecodeProtector = 'IVMBytecodeProtector',
    IVMCompiler = 'IVMCompiler',
    IVMFunctionSelector = 'IVMFunctionSelector',
    IVMRuntimeBuilder = 'IVMRuntimeBuilder',
    IVMSerializer = 'IVMSerializer',
